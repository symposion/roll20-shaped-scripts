...
class Command {
  ...
  optionLookup(groupName, lookup) {
    if (typeof lookup !== 'function') {
      lookup = _.propertyOf(lookup);
    }
    this.parsers.push((arg, errors, options) => {
  ...
  handle(args, selection) {
    ...
    const finalOptions = _.reduce(args, (options, arg) => {
