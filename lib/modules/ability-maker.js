...
module.exports = class AbilityMaker extends ShapedModule {
  ...
  addCommands(commandProcessor) {
    ...
    this.staticAbilityOptions = {
      ...
      offenseMacro: new RepeatingSectionMacroMaker('shaped_offense', 'roll', 'Offense', roll20),
      utility: new RepeatingAbilityMaker('utility', 'roll', 'Utility', true, roll20),
      utilityMacro: new RepeatingSectionMacroMaker('shaped_utility', 'roll', 'Utility', roll20),
