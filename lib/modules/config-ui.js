...
class ConfigMenu {
  ...
  getMenu() {
    ...
    const th = Utils.buildHTML('th', parts.title, { colspan: '2' });
    const tr = Utils.buildHTML('tr', th, { style: 'margin-top: 5px;' });
    const footer = Utils.buildHTML('tr', Utils.buildHTML('td', parts.footerText, { colspan: '2' }));
    return Utils.buildHTML('table', tr + parts.optionRows + footer, {
