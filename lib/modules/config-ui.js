...
class NewCharacterHouseruleMenu extends ConfigMenu {
  getMenuParts() {
    ...
    const optionRows =
      this.makeQuerySetting({
        path: `${hr}.hitPointsRecoveredOnALongRest`,
        title: 'Hit points recovered on a Long Rest',
        prompt: 'Hit points recovered on a Long Rest',
        menuCmd: menu, spec: this.specRoot.newCharSettings.houserules.hitPointsRecoveredOnALongRest(),
      }) +
      this.makeQuerySetting({
        path: `${hr}.hitDiceRecoveredOnALongRest`,
        title: 'Hit dice recovered on a Long Rest',
        prompt: 'Hit dice recovered on a Long Rest',
        menuCmd: menu, spec: this.specRoot.newCharSettings.houserules.hitDiceRecoveredOnALongRest(),
      }) +
      this.makeQuerySetting({
        path: `${hr}.hitDiceRecoveredOnAShortRest`,
        title: 'Hit dice recovered on a Short Rest',
        prompt: 'Hit dice recovered on a Short Rest',
        menuCmd: menu, spec: this.specRoot.newCharSettings.houserules.hitDiceRecoveredOnAShortRest(),
      }) +
      this.makeQuerySetting({
