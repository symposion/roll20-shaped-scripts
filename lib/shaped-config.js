...
const migrator = new Migrator()
  ...
  .transformConfig((config) => {
    ...
    baseConfig.hitDiceRecoveredOnAShortRest = baseConfig.hitDiceRecoveredOnAShortRest || '0';
    return config;
  ...
  .addProperty('config.newCharSettings.houserules.hitDiceRecoveredOnAShortRest', '***default***');
...
module.exports = class ShapedConfig extends ShapedModule {
  ...
  static get configToAttributeLookup() {
    const lookup = {
      ...
      hitDiceRecoveredOnAShortRest: 'hit_dice_recovered_on_a_short_rest',
    };
    ...
    return {
      ...
      newCharSettings: {
        ...
        houserules: {
          ...
          hitDiceRecoveredOnAShortRest: this.getOptionList({
            None: '***default***',
            '1/4': 'FOURTH',
            Half: 'HALF',
            All: 'ALL',
